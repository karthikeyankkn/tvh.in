$(document).ready(function() {
    ...
    var short_traverse, data, check_inner_page = false,
        selected_package, ApiEndPoint, url, homepage_category, banner_heading, banner_background, cards, show_cards, card_limit_start, card_limit_end, card_location, feature_add_title, feature_add_href, feature_add_href_title, url_hash, card_category, backend_api_url;
    ...
    // images for desktop
    var desktop_img = ["http://s3-ap-southeast-1.amazonaws.com/cdn.getspini.com/banner/Alliance-Banner.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/L-T-Cover.jpg",
        "http://s3-ap-southeast-1.amazonaws.com/cdn.getspini.com/banner/Casagrand-Thalambur-Banner.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/optimized/nest-bn.jpg",
        "http://s3-ap-southeast-1.amazonaws.com/cdn.getspini.com/banner/Fomra-Hues-Banner.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Fortune1.jpg",
        "../assets/images/banner/Nest_20Kanathur.jpg",
        "http://s3-ap-southeast-1.amazonaws.com/cdn.getspini.com/banner/Godrej-azure-Banner.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Suraj1.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/BSR-Cover.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Life1.jpg"
    ];
    // images for mobile
    var mobile_img = ["http://cdn.getspini.com.s3.amazonaws.com/banner/alliance-banner-mob.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/L-T-Mob.jpg",
        "http://cdn.getspini.com.s3.amazonaws.com/banner/casagrand-banner-mob.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/nest-mob-v2-1.jpg",
        "http://cdn.getspini.com.s3.amazonaws.com/banner/fomra-banner-mob.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Fortune-Mob1.jpg",
        "../assets/images/banner/Nest_20Mob.jpg",
        "http://cdn.getspini.com.s3.amazonaws.com/banner/godrej-banner-mob.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Suraj-Mob1.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/BSR-Mob.jpg",
        "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/banner/Nest-Life-Mob1.jpg"
    ];
    // links for slider
    var slider_link = ["https://getspini.com/alliance-residential-apartments-in-padur.html",
        "../realestate/l-and-t-eden-park-siruseri.html",
        "../realestate/casagrand-supremus.html",
        "../realestate/nest-amaze-Sholinganallur.html",
        "../realestate/fomra-hues.html",
        "../realestate/nest-fortune-choolaimedu.html",
        "../realestate/nest-njoy-villa-kanathur.html",
        "../realestate/godrej-azure.html",
    ...
    $(".submit_innerpage").click(function() {
        ...
        if ([name, ph_number, email, cityName, budgetAmount].includes('')) {
            ...
            check_inner_page = true;
            $(".bg-overlay, .gs_loading").css("display", "block");
            $(this).prop('disabled', true);
            success_contact_form();
        }
    });
    ...
    function senddata() {
        $(".bg-overlay, .gs_loading").show();
        // debugger
        if (categoryName == "loan_emi_calculator") {
            // debugger
            $.ajax({
                url: backend_api_url + "lead/emi_calculator",
                method: "POST",
                data: {
                    "ec_lead": {
                        "name": name,
            ...
            data = {
                "lead": {
                    "name": name+"[ "+additional_description+" ]",
                    "phone_number": ph_number,
                    "city": cityName,
                    "category": categoryName,
                    "email": email,
            ...
            $.post(backend_api_url + "leads", data,
                function(data, status) {
                    if (status == "success") {
                        $.ajax({
                            ...
                            data: JSON.stringify({
                                "prospectiveBuyersName": name+"[ "+additional_description+" ]",
    ...
    $(".submit_estimation").click(function() {
        ...
        function interior_estimate_mailsend() {
            $.ajax({
                url: backend_api_url + "lead/interior_estimation",
                method: "POST",
                data: {
                    "ie_lead": {
                        "name": uname,
                        "phone_number": umobile,
                        "email": uemail,
    ...
    $(".home-page-categories li").click(function() {
        ...
        if (homepage_category == 'realestate') {
            ...
            banner_background = "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/bg-index.jpg";
            ...
            banner_background = "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/interior-banner.jpg";
            ...
            banner_background = "https://s3.ap-south-1.amazonaws.com/cloudflare.getspini.com/loan-banner.jpg";
    ...
    function get_json(index) {
        $.get("../assets/js/v1.30.63/" + card_category + ".json", function(data, status) {
            // debugger
            cards = data.cards;
            cards = cards.reverse();
